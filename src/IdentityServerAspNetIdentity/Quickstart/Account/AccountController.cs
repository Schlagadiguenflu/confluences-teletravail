        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return Redirect(_configuration["URLClientMVC"]);
                    }
                    else if (model.ReturnUrl == _configuration["URLClientMVC"])
                    {
                        return Redirect(_configuration["URLClientMVC"] + "Account/SignIn");
                    }
                    else
                    {
